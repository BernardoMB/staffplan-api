CREATE DATABASE  IF NOT EXISTS `sandbox_master` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `sandbox_master`;
-- MySQL dump 10.13  Distrib 5.7.17, for macos10.12 (x86_64)
--
-- Host: rds.coqokg7f9b0o.us-west-1.rds.amazonaws.com    Database: sandbox_master
-- ------------------------------------------------------
...
INSERT INTO `SUBSCRIBER` VALUES (1,1,'2028-11-18 00:00:00',1,'staffplan.io'),(2,2,'2018-11-18 00:00:00',1,'acme.io');
...
INSERT INTO `SUBSCRIPTION_SERVICE` VALUES (1,1,1,10,'2019-01-15 00:00:00','2019-01-15 00:00:00',1,1);
...
INSERT INTO `SUBSCRIPTION_TYPE` VALUES (1,'monthly','monthly use of staff plan service','110','2019-01-15 00:00:00','2019-01-15 00:00:00',1,1);
...
INSERT INTO `TENANT_DETAILS` VALUES (1,1,'2019-01-15','staffplan.io','active'),(1,2,'2019-01-15','staffplan.io','active'),(1,3,'2019-01-15','staffplan.io','active'),(2,1,'2019-01-15','acme.io','active');
...
INSERT INTO `TENANT_TYPE` VALUES (1,'trial',1),(2,'prod',1),(3,'staging',1);
/*!40000 ALTER TABLE `TENANT_TYPE` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'sandbox_master'
--

--
-- Dumping routines for database 'sandbox_master'
--
...
-- Dump completed on 2019-02-21 16:11:21
