...
VALUES
	...
	(2,'Dashboard','ProposalDesc','Number of projects proposals'),
	(3,'Dashboard','InProgress','In Progress'),
	(4,'Dashboard','InProgressDesc','Number of projects awarded and in progress'),
	(5,'Dashboard','OpenRole','Open Role'),
	(6,'Dashboard','OpenRoleDesc','Number of roles that are open for staff assignment'),
	(7,'Dashboard','AssignmentGap','Assignment Gap'),
	(8,'Dashboard','AssignmentGapDesc','Number of staff that have gaps between their assignments'),
	(9,'Dashboard','AllocationAlert','Allocation Alert'),
	(10,'Dashboard','AllocationAlertDesc','Number of staff that have allocation alerts (over or under allocated)'),
	(11,'Dashboard','Bench','Staff on Bench'),
	(12,'Dashboard','BenchDesc','Number of staff on bench'),
