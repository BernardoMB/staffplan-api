...
DROP TABLE IF EXISTS `TIMELINE_DATE`;
...
(255) DEFAULT NULL,
  `PHONE_1` varchar
(255) DEFAULT NULL,
  `PHONE_1_TYPE` varchar
(255) DEFAULT NULL,
  `PHONE_2` varchar
(255) DEFAULT NULL,
  `PHONE_2_TYPE` varchar
(255) DEFAULT NULL,
  `HOME_CITY` varchar
(255) DEFAULT NULL,
  `HOME_STATE` varchar
...
(`STAFF_GROUP_ID`),
  KEY `OFFICE_ID`
(`OFFICE_ID`),
  CONSTRAINT `FK_349` FOREIGN KEY
(`STAFF_STATUS_ID`) REFERENCES `STAFF_STATUS`
(`STATUS_ID`),
  CONSTRAINT `staff_ibfk_1` FOREIGN KEY
(`STAFF_ROLE_ID`) REFERENCES `STAFF_ROLE`
(`ROLE_ID`),
  CONSTRAINT `staff_ibfk_2` FOREIGN KEY
(`STAFF_GROUP_ID`) REFERENCES `STAFF_GROUP`
(`GROUP_ID`),
  CONSTRAINT `staff_ibfk_3` FOREIGN KEY
...
(`PROJECT_ID`),
  KEY `fkIdx_341`
(`GROUP_ID`),
  CONSTRAINT `FK_341` FOREIGN KEY
(`GROUP_ID`) REFERENCES `PROJECT_GROUP`
(`GROUP_ID`),
  FOREIGN KEY
(`PROJECT_STATUS_ID`) REFERENCES `PROJECT_STATUS`
(`STATUS_ID`),
  FOREIGN KEY
...
(`CATEGORY_ID`),
  FOREIGN KEY
(`TIMELINE_TYPE_ID`) REFERENCES `TIMELINE_TYPE`
(`TIMELINE_TYPE_ID`),
  FOREIGN KEY
(`CUSTOMER_ID`) REFERENCES `CUSTOMER`
(`CUSTOMER_ID`),
...
(11) unsigned NOT NULL,
  `CONFIRMED` tinyint
(1) DEFAULT NULL,
  `RESUME_SUBMITTED` enum
('0','1') NOT NULL DEFAULT '0' COMMENT '0: false , 1: true',
  `PROJECT_ID` int
(11) unsigned NOT NULL,
  PRIMARY KEY
(`ID`),
...
(`PROJECT_ID`),
  FOREIGN KEY
(`PROJECT_ROLE_ID`) REFERENCES `STAFF_ROLE`
(`ROLE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(`PROJECT_ID`),
  KEY `PROJECT_ROLE_ID`
(`PROJECT_ROLE_ID`),
  CONSTRAINT `project_staff_ibfk_1` FOREIGN KEY
(`STAFF_ID`) REFERENCES `STAFF`
(`STAFF_ID`),
  CONSTRAINT `project_staff_ibfk_2` FOREIGN KEY
(`PROJECT_ID`) REFERENCES `PROJECT`
(`PROJECT_ID`),
  CONSTRAINT `project_staff_ibfk_3` FOREIGN KEY
(`PROJECT_ROLE_ID`) REFERENCES `STAFF_ROLE`
(`ROLE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(`STAFF_ID`),
  FOREIGN KEY
(`CERTIFICATION_ID`) REFERENCES `CERTIFICATION_SKILLS`
(`CERTIFICATION_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(11) unsigned NOT NULL,
  PRIMARY KEY
(`EXPERIENCE_ID`,`STAFF_ID`, `PROJECT_ID`),
  KEY `fkIdx_355`
(`EXPERIENCE_ID`),
  KEY `fkIdx_358`
(`STAFF_ID`),
  KEY `fkIdx_363`
(`PROJECT_ID`),
  CONSTRAINT `FK_355` FOREIGN KEY
(`EXPERIENCE_ID`) REFERENCES `EXPERIENCE`
(`EXPERIENCE_ID`),
  CONSTRAINT `FK_358` FOREIGN KEY
(`STAFF_ID`) REFERENCES `STAFF`
(`STAFF_ID`),
  CONSTRAINT `FK_363` FOREIGN KEY
(`PROJECT_ID`) REFERENCES `PROJECT`
(`PROJECT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(`OFFICE_ID`),
  KEY `fkIdx_386`
(`REGION_ID`),
  CONSTRAINT `FK_380` FOREIGN KEY
(`USER_ID`) REFERENCES `USERS`
(`USER_ID`),
  CONSTRAINT `FK_383` FOREIGN KEY
(`OFFICE_ID`) REFERENCES `OFFICE`
(`OFFICE_ID`),
  CONSTRAINT `FK_386` FOREIGN KEY
(`REGION_ID`) REFERENCES `REGION`
(`REGION_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(`PROJECT_ID`),
  FOREIGN KEY
(`NODE_PARENT_ID`) REFERENCES `NOTES`
(`NOTE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(`ID`),
  KEY `CALENDAR_ID`
(`CALENDAR_ID`),
  KEY `PROJECT_STAFF_ID`
(`PROJECT_STAFF_ID`),
  CONSTRAINT `staff_allocation_ibfk_1` FOREIGN KEY
(`CALENDAR_ID`) REFERENCES `CALENDAR`
(`CALENDAR_ID`),
  CONSTRAINT `staff_allocation_ibfk_2` FOREIGN KEY
(`PROJECT_STAFF_ID`) REFERENCES `PROJECT_STAFF`
(`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
