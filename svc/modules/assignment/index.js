...
module.exports = (app) => {
  ...
  app.post(`/${CONST.API}/${MODULE}/:id/role`, authenticate.isAuthenticated, assignment.getProjectRoleCalendar);
  ...
  app.post(`/${CONST.API}/${SUBMODULE}/update-allocation`, authenticate.isAuthenticated, assignment.updateAllocation);
}